...
CREATE TABLE `societe` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKkssweshd69jb03tskpyxo66if` (`type`),
  CONSTRAINT `FKkssweshd69jb03tskpyxo66if` FOREIGN KEY (`type`) REFERENCES `type_societe` (`id`)
...
INSERT INTO `societe` VALUES (4,NULL,NULL,NULL,NULL,'45S4A9','AD CONSULTING','BSSSSD','A',1);
