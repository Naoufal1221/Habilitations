package org.telio.portail_societe;
...
public class PortailSocieteApplication implements CommandLineRunner {
...
//		TypeEntiteDTO foundDirection = typeEntiteConverter.toVo(typeEntiteRepository.findByNom("Direction General"));
//
...
//
//		EntiteDTO foundRegion = entiteConverter.toVo(entiteRepository.findByNom("Direction Regional"));
//
//		System.out.println("======================================");
